...
<script type="text/javascript" >
  ...
  $(function(){
	  $("a[title]").click(function(){
			...
			var url2 = '../test';
			var title = $(this).html();
			if($("#tt").tabs('exists',title)){//判断选项卡是否存在 存在返回true 
				$('#tt').tabs('select',title);//跳到指定参数的tab页上
			}else{
				$("#tt").tabs('add',{
					  title:title,    
					  //content:'<iframe  style=width:100%;height:570px src='+ url +' ></iframe>',   
					  content:"<iframe style='width:100%;height:570px' src='"+url2+"'></iframe>",
					  closable:true
				 })	
			}
		})
...
<body>
 ...
 <div id="cc" class="easyui-layout" style="width:100%;height:100%;" data-options="fit:true">   
   ...
   <div class="easyui-accordion" data-options="fit:true,title:'用户管理'">
	 	 <div title="用户管理" data-options="fit:true">
	 		<a  title="demo.html">用户列表</a><br>
	 		<a  title="demo1.html">用户信息</a>
	 	</div>
